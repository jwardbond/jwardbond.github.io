...
{{< figure
    ...
    caption="They weren't all great. I think this I ran into some tokenization challenges with \"bluepoint ragdoll\" and \"crosseyed\". Oddly enough even using \"strabismus\" resulted in x's on his eyes. I also removed \"South Park\" as a potential style after this one.">}}
...
{{< figure
    ...
    caption="On the left is the image as displayed on my computer, and on the right is the image displayed on the Seeed E1002 color e-ink display. FS=Floyd-Steinberg. Dithering with the percieved colors on the display and then mapping this result back to the 6-colors the e-ink screen expects results in a brighter image. This is opposed to just dithering with the 6 reference colors. You can read below for more details.">}}

The actual colours on Spectra 6 screens don't _quite_ match the reference colours from the specs. For instance, although the documentation says it displays #00ff00 (green), the colour that is actually displayed is something much less intense, like #608050 (olive green). This knowledge can be used to make the final image more true to the color of the original: to minimize the difference between the displayed image and the generated image, I dither with the actual colour palette and then convert back to the reference pallete before displaying. I don't have a way to measure the actual colours of the display, so I just use the Sepctra 6 colour map from Robert Gühne's [epdoptimize library](https://github.com/Utzel-Butzel/epdoptimize/blob/2c0cbb8ad72ce9fad6337c94d0557cb7651a2883/src/dither/data/default-palettes.json) to convert between actual and reference colours.
...
[^1]: Descriptions of my cats: "Milo is a domestic short-haired tabby. He is seven years old and we like to imagine that he is serious but a little goofy on the outside. He has green eyes, with big pupils when he is excited. He loves cuddling, sitting on his moms lap, his little brother Tolmie, holding little pom-poms in his mouth, and stealing kibbles from his brother. You can just _barely_ see a little bit of his pink skin beneath his tummy fur, but it is cute and fuzzy with some paunch. He has cute white paws and a white tummy." & "Tolmie is a ragdoll, he has pretty blue eyes, and his black pupils get big when he's excited. We like to imagine that he is goofy. He loves his big brother Milo, playing with strings, rolling on the ground belly-up, and sprinting full speed around the house yelling. He is a little bigger (longer) than Milo, and all fluff. When he is happy he likes to stick his tail up."
